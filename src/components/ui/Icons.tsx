...
export function SparkIcon(props: IconProps) {
  return <svg viewBox="0 0 24 24" aria-hidden="true" {...props}><path fill="currentColor" d="M12 2c.5 5.35 4.65 9.5 10 10-5.35.5-9.5 4.65-10 10-.5-5.35-4.65-9.5-10-10 5.35-.5 9.5-4.65 10-10Z"/></svg>;
}
